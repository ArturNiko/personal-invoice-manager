            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <label class="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300">
                    <input
                        v-model="remember"
                        type="checkbox"
                        class="h-4 w-4 rounded border-slate-900/20 bg-white text-cyan-700 focus:ring-cyan-700 dark:border-white/20 dark:bg-slate-900 dark:text-cyan-400 dark:focus:ring-cyan-500"
                    />
                    {{ t('auth.rememberMe') }}
                </label>
