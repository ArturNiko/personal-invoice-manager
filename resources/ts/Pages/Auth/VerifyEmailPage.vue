...
<template>
    ...
    >
        <div
            class="w-full max-w-lg rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-slate-950/50 backdrop-blur-xl sm:p-8"
        >
            ...
            <div
                class="rounded-2xl border border-amber-400/25 bg-amber-500/10 p-5 text-sm text-amber-100"
            >
            ...
            <div
                v-if="error"
                class="mt-5 rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm text-red-300"
            >
                {{ error }}
            </div>
