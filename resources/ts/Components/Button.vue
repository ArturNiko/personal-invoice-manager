...
const variantClasses: Record<NonNullable<typeof props.variant>, string> = {
    ...
    outline:
        'border-white/15 bg-slate-950/55 text-slate-300 shadow-sm shadow-slate-950/15 hover:border-cyan-400/45 hover:bg-slate-900/75 hover:text-white',
    ...
    emerald:
        'border-emerald-400/35 bg-emerald-500/15 text-emerald-50 shadow-sm shadow-slate-950/15 hover:bg-emerald-500/25',
