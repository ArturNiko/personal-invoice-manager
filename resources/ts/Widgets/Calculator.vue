...
<template>
    <div class="mx-auto w-full max-w-[500px] text-slate-900 dark:text-slate-100">
        <div
            class="mb-4 text-center text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-600 dark:text-slate-400"
        >
            Tally <span class="text-orange-400">·</span> desk calculator
        </div>

        <div
            class="relative z-10 rounded-[22px] bg-gradient-to-br from-slate-300 to-slate-200 dark:from-slate-700 dark:to-slate-800 p-[18px] shadow-[0_24px_50px_-20px_rgba(15,23,42,0.4),inset_0_1px_0_rgba(255,255,255,0.06),inset_0_-1px_0_rgba(15,23,42,0.25)]"
        >
            <div
                class="mb-[14px] flex min-h-[96px] flex-col justify-end overflow-hidden rounded-[14px] bg-slate-100 dark:bg-slate-950 px-[18px] pb-4 pt-[22px] shadow-inner shadow-slate-500/60 dark:shadow-black/60"
            >
                <div
                    ref="topLineRef"
                    class="calculator-scrollbar-none h-4 overflow-x-auto overflow-y-hidden whitespace-nowrap text-right font-mono text-[12px] tracking-[0.02em] text-slate-500"
                >
                    {{ expression || '\u00A0' }}
                </div>
                <div
                    ref="mainLineRef"
                    class="calculator-scrollbar-none overflow-x-auto overflow-y-hidden whitespace-nowrap text-right font-mono text-[clamp(24px,7.2vw,38px)] font-semibold leading-[1.15] text-slate-900 dark:text-slate-100"
            ...
            <div class="grid grid-cols-4 gap-2">
                <button
                    class="h-[52px] sm:h-[58px] rounded-xl border border-transparent bg-slate-300 dark:bg-slate-700 font-sans text-[15px] sm:text-[16px] font-semibold text-slate-800 dark:text-slate-200 shadow-[0_2px_0_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.03)] transition duration-[60ms] hover:bg-slate-400 dark:hover:bg-slate-600 active:translate-y-[2px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
                    @click="clearAll"
                >
                    C
                </button>
                ...
                <button
                    class="h-[52px] sm:h-[58px] rounded-xl border border-transparent bg-slate-200 dark:bg-slate-800 font-mono text-[18px] sm:text-[19px] font-medium text-slate-900 dark:text-slate-100 shadow-[0_2px_0_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.03)] transition duration-[60ms] hover:bg-slate-300 dark:hover:bg-slate-700 active:translate-y-[2px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
                    @click="inputDigit('7')"
                >
                    7
                </button>
                ...
                <button
                    class="col-span-2 h-[52px] sm:h-[58px] rounded-xl border border-transparent bg-slate-200 dark:bg-slate-800 font-mono text-[18px] sm:text-[19px] font-medium text-slate-900 dark:text-slate-100 shadow-[0_2px_0_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.03)] transition duration-[60ms] hover:bg-slate-300 dark:hover:bg-slate-700 active:translate-y-[2px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
                    @click="inputDigit('0')"
                >
                    0
                </button>
        ...
        <div ref="tapeSection" class="mt-3.5">
            <button
                class="flex w-full items-center justify-between rounded-xl bg-white dark:bg-slate-900 px-4 py-3 text-[12px] font-semibold uppercase tracking-[0.1em] text-slate-600 dark:text-slate-400 transition duration-150 hover:bg-slate-200 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
                @click="toggleHistory"
            >
            ...
            <template v-if="historyOpen">
                ...
                <button
                    v-if="history.length"
                    class="block w-full appearance-none border-0 bg-transparent px-0 py-2 text-[11px] uppercase tracking-[0.08em] text-slate-600 dark:text-slate-400 underline underline-offset-[3px] transition hover:text-orange-400"
                    @click="clearHistory"
                >
                    Clear tape
                </button>
